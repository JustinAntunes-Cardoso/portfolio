		...
		<section
			...
			<article className='about__info-container'>
				...
				<p className='about__text'>
					...
					skills in HTML, CSS, JavaScript, TypeScript, React, SCSS, Node.js,
					MySQL, Linux & Python. I'm equipped with a unique combination of
					technical knowledge and problem-solving skills, enabling me to develop
					efficient and effective software solutions. My ability to communicate
					complex technical concepts in a clear and concise manner allows me to
					work collaboratively with teams across multiple departments. My strong
